...
vault write auth/$authMethodName/role/$secretPath-secrets bound_service_account_names=external-secrets-kubernetes-external-secrets bound_service_account_namespaces=monitoring,tooling policies=$secretPath-secrets ttl=24h;
